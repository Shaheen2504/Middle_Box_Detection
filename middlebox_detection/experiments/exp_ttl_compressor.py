"""
EXP TTL-B — TTL failure with Compressor
Purpose: Show TTL cannot localize compressor (apparent Dl < 2% per hop)
Expected: max_apparent_Dl < 5%, ttl_localization_detected = False
Run: sudo python3 experiments/exp_ttl_compressor.py
"""
