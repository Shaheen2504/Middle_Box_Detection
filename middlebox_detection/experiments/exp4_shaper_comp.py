"""
EXP 4 — Shaper + Compressor (two-chain)
Purpose: Detect chained MB1+MB2; shaper masks compressor effect
Expected: Median Dl ~EXP1, MIDDLEBOX DETECTED
Run: sudo python3 experiments/exp4_shaper_comp.py
"""
