"""
EXP 1 — Traffic Shaper
Purpose: Detect MB1 (tc HTB shaping port 9000 to 2 Mbps)
Expected: Median Dl 40-55%, MIDDLEBOX DETECTED
Run: sudo python3 experiments/exp1_shaper.py
"""
