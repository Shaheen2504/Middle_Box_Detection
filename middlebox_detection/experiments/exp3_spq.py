"""
EXP 3 — Strict Priority Queue
Purpose: Detect MB3 (tc PRIO starves low-priority probe-A)
Expected: Median Dl 40-60%, MIDDLEBOX DETECTED
Run: sudo python3 experiments/exp3_spq.py
"""
